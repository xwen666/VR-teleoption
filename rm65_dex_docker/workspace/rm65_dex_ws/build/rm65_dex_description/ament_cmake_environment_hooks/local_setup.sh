...
: ${AMENT_CURRENT_PREFIX:="/workspace/rm65_dex_ws/install/rm65_dex_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rm65_dex_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rm65_dex_description/environment/path.sh"
