...
: ${AMENT_CURRENT_PREFIX:="/workspace/rm65_dex_ws/install/rm65_dex_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rm65_dex_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rm65_dex_moveit_config/environment/path.sh"
